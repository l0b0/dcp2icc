...
if platform == "win32":
	...
	LIBS=["dng_1_2","XMPFiles-CC-201306","XMPCore-CC-201306","XMPcommon-CC-201306","expat","lcms-1.17"],
       	LINKFLAGS="",
       	CCFLAGS="-O2 -iquote-",
       	tools=["mingw"],
	...
	LIBS=["dng_1_2","XMPFiles-CC-201306","XMPCore-CC-201306","XMPcommon-CC-201306","expat","lcms","pthread"],
   	LINKFLAGS="",
   	CCFLAGS="-O2 -iquote-",
   	LCMS_INCLUDE=None)
